// admin/src/app/dashboard/test/[id]/TestDetailsPage.tsx
"use client";
        ...
        <div className="bg-white border-b px-6 py-4">
          <div className="flex justify-between items-start">
            ...
            <div className="flex space-x-2">
              <Button
                variant="outline"
                onClick={() => router.push(`/dashboard/test/${testId}/edit`)}
              >
        ...
        <div className="p-6 space-y-6">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button
                onClick={() => router.push(`/dashboard/test/${testId}/question/create`)}
                        ...
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="flex space-x-1 ml-4">
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => router.push(`/dashboard/test/${testId}/question/${question.id}/edit`)}
