...
import { createNews } from "@/app/dashboard/news/services/api";
import { ArrowLeft, FileText, Save, Eye, PenTool, Trash2, Upload, Tag, FolderOpen } from "lucide-react";
import Link from "next/link";
import { useState, useEffect } from "react";
import { fetchCategories, fetchTags } from "@/app/dashboard/news/services/api";
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Add a new article to your news feed</p>
                        </div>
                    </div>
                </div>
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                        ...
                                        <FormItem className="space-y-3">
                                            ...
                                            <FormControl>
                                                <Input 
                                                    ...
                                                    className="h-12 text-base bg-white/60 border-gray-200 focus:border-blue-400 focus:ring-blue-400/20 transition-all duration-200"
                                                />
                                            </FormControl>
                                        ...
                                        <FormItem className="space-y-3">
                                            ...
                                            <FormControl>
                                                <textarea 
                                                    ...
                                                    className="w-full h-48 p-4 text-base bg-white/60 border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 resize-none transition-all duration-200 placeholder:text-gray-400"
                                                />
                                            </FormControl>
                                            <FormMessage className="text-red-500" />
                                        </FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        onBlur={onBlur}
                                                        ref={ref}
                                                        className="w-full h-12 px-4 text-base bg-white/60 border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200 file:bg-gray-100 file:border-0 file:rounded file:px-3 file:py-2 file:text-sm file:font-medium"
                                                    />
                                                </div>
                                            </FormControl>
                                            {selectedFile && (
                                        ...
                                        <FormItem className="space-y-3">
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    <select
                                                        {...field}
                                                        className="w-full h-12 pl-12 pr-4 text-base bg-white/60 border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 appearance-none cursor-pointer transition-all duration-200"
                                                    >
                                ...
                                <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                                    <p className="text-sm text-gray-500">
                                        All required fields must be filled. Your article will be saved with the selected status.
                                    </p>
                                    <Button 
                                        type="submit"
                                        disabled={isLoading}
                                        className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 h-auto text-base font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                    >
                                        {isLoading ? (
                                            <>
