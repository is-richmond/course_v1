...
async def setup_admin_commands(bot: Bot):
    ...
    admin_commands = [
        ...
        BotCommand(command="delete_message", description="🗑️ Удалить сообщение"),
        BotCommand(command="delete_reminder_type", description="🗑️ Удалить тип напоминания"),
        ...
        BotCommand(command="delete_streak_msg", description="🗑️ Удалить поздравление"),
