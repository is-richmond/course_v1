...
то есть ты повторяешь материал ровно в то�� момент, когда мозг начинает его забывать.  Алгоритм подкреплен десятками исследований в области нейронауки и памяти, именно поэтому Anki реально работает.
